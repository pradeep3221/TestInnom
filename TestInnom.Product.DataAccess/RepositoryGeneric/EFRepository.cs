...
namespace TestInnom.Product.DataAccess.DAL
{
    ...
    {
        private TestInnomDBContext dbContext;

        public EFRepository()
        {
            dbContext = new TestInnomDBContext();
        }
        ...
        public virtual T Create<T>(T TObject) where T : class
        {
            ...
            return newEntry.Entity; //https://entityframeworkcore.com/knowledge-base/48363894/where-is-idbset-t--in-entity-core //https://q.cnblogs.com/q/89456/
        }
